        ...
        <div class="container">
            <div class="col-lg-9">
                <div class="main-title mb32 mt50 d-flex justify-content-between align-items-center">Мои резюме
                    <a href="<?= Url::toRoute('site/edit_reg_resume'); ?>" class="link-orange-btn orange-btn my-vacancies-add-btn">Добавить резюме</a><a
                                    ...
                                    <div class="row">
                                        <div class="my-resume-dropdown dropdown show mb8">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="<?= Url::to(['site/edit_reg_resume', 'id'=>$model->id]) ?>">Редактировать</a>
                                                <a class="dropdown-item" href="<?= Url::to(['site/resume_del', 'id'=>$model->id]) ?>">Удалить</a>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-wrap mobile-mb12">
                                                <a class="mr16" href="<?= Url::to(['site/resume_view', 'id'=>$model->id]) ?>">Открыть</a>
                                            </div>
